...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_detailinfo', (
            ...
            ('avatar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image.Image'], null=True, blank=True)),
            ...
            ('native', self.gf('mptt.fields.TreeForeignKey')(to=orm['location.Location'], null=True, blank=True)),
            ...
            ('idcard_image', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('weibo', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('blog', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'account.detailinfo': {
            ...
            'avatar': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['image.Image']", 'null': 'True', 'blank': 'True'}),
            'blog': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idcard': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'idcard_image': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'mobile': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'native': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['location.Location']", 'null': 'True', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['users.CustomUser']", 'unique': 'True'}),
            'weibo': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'account.fundinfo': {
