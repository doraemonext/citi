...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.sn'
        db.alter_column(u'fund_order', 'sn', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

    def backwards(self, orm):

        # Changing field 'Order.sn'
        db.alter_column(u'fund_order', 'sn', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
