...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fund_orderpackage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_id', self.gf('django.db.models.fields.IntegerField')()),
            ('sn', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('package_id', self.gf('django.db.models.fields.IntegerField')()),
            ('package_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('package_money', self.gf('django.db.models.fields.FloatField')()),
            ('package_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'fund', ['OrderPackage'])


    def backwards(self, orm):
        # Deleting model 'OrderPackage'
        db.delete_table(u'fund_orderpackage')
