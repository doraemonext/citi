...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetailInfo.nickname'
        db.add_column(u'users_detailinfo', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetailInfo.nickname'
        db.delete_column(u'users_detailinfo', 'nickname')
