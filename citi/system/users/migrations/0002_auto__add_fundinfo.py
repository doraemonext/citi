...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_fundinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('alipay', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('bank_sub_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('account', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'users', ['FundInfo'])


    def backwards(self, orm):
        # Deleting model 'FundInfo'
        db.delete_table(u'users_fundinfo')
    ...
    models = {
        ...
        u'users.detail': {
            ...
            'qq': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
        ...
        u'users.fundinfo': {
            ...
            'alipay': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'bank_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'bank_sub_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        }
